 ...
 * @description Gère l'authentification, le profil utilisateur et les mises à jour du userName.
 ...
 * Simule un appel API pour se connecter avec un email et un mot de passe.
 * @async
 * @function loginUser
 ...
 * Gère le login, le logout, le profil utilisateur et les mises à jour du userName.
 * @namespace authSlice
 */
